/*
Question What are the moist optimal skills  for data engineering_balancing both demand and salary?
- Create a ranking coulmn that combines demand count and median salary to identify the most valuable skills.
- Focus only on remote Data Engineer positions with specified annual salaries.
- Why?
    - This approach highlights skills that balanace market demand and financial reward. It weights core skills approach
*/

SELECT 
    sd.skills,
    ROUND(MEDIAN (jpf.salary_year_avg),1)AS median_salary,
    COUNT(jpf.*) AS corrected_demanded_count,
...
┌────────────┬───────────────┬──────────────────────────┬─────────────────┬───────────────┐
│   skills   │ median_salary │ corrected_demanded_count │ ln_demand_count │ optimal_score │
